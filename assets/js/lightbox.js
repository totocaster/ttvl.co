const lightbox = {
  ...
  init() {
    document
      .querySelectorAll('article a > img, .leafs-grid a > img')
      .forEach((img) => {
  ...
  open(src) {
    ...
    this.overlay.style.cssText =
      'position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.9);z-index:1000;display:flex;align-items:center;justify-content:center;cursor:pointer;';

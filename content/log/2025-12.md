...
-	Published v0.2 of the [Plaintext Commons](https://www.jinnystreetgallery.com/exhibitions/thecreatorsclub) website.
-	Signed [The Resonant Computing Manifesto](https://resonantcomputing.org/).
-	Finally found a use for [TRMNL](https://usetrmnl.com/) and build an [health display plugin](https://github.com/totocaster/trmnl-health-display) for daily weight and trend tracking.

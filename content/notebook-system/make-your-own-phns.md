---
title: 'Make Your Own PHNS: A DIY Guide'
---

# Make Your Own PHNS: A DIY Guide

This is a guide to making the canonical (version I use) [PHNS][phns] notebook. The entire system is designed to be loose and flexible, tailored to fit only me. I encourage you to use the following information as inspiration and modify the steps to make a notebook that matches _you_.
...
- **Blade or Scissors**: For cutting the cover material of your choice. You can use a sheet of your notebook paper as a size guide since PHNS covers are exactly the same size as the notebook paper.
...
## Toto's PHNS Notebook

Below are the materials and brands _I_ use for my PHNS notebooks:
...
- **Binder**: **AC-RING 16R**, which has no mounting hardware for covers—perfect for the PHNS "cover-as-pages" style. It’s slightly awkward to open compared to classic ring binders, but it’s the best I’ve found.
...
For my few [custom templates][templ], I use colored paper (e.g., yellow, pink, blue) to make them easily identifiable. For example, I print film log templates on pale-yellow paper and keep them at the end of my notebook.

## Curious Accessories

- **Canon ZINK Mini-Printers**: These compact printers require no ink (though they use specialized paper) and print on pre-made stickers that fit most PHNS papers perfectly. I frequently print photos to glue into my notes.
...
I hope this guide inspires you to create your own PHNS notebook.
